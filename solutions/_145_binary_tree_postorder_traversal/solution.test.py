...
class TestSolution(unittest.TestCase):
    ...
    def test_0(self):
        s = Solution()
        actual = s.postorderTraversal(create_binary_tree([1, None, 2, 3]))
        expected = [3, 2, 1]
        self.assertEqual(actual, expected)

    def test_1(self):
        s = Solution()
        actual = s.postorderTraversal(create_binary_tree([]))
        expected = []
        self.assertEqual(actual, expected)

    def test_2(self):
        s = Solution()
        actual = s.postorderTraversal(create_binary_tree([1]))
        expected = [1]
        self.assertEqual(actual, expected)
