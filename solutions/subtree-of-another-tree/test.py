...
class TestSolution(unittest.TestCase):
    def test_0(self):
        self.assertEqual(s.isSubtree(create_binary_tree(
            [3, 4, 5, 1, 2]), create_binary_tree([4, 1, 2])), True)

    def test_1(self):
        self.assertEqual(s.isSubtree(
            create_binary_tree([3, 4, 5, 1, 2, None, None, None, None, 0]), create_binary_tree([4, 1, 2])), False)
